...
public class JdbcTransferDao implements TransferDao{
    ...
    @Override
    public List<Transfer> listTransfersById(int userId) {
    ...
    public int sendTransfer(int fromUserId, int toUserId, BigDecimal transferAmount) {
        ...
        Integer transferId = jdbcTemplate.queryForObject(sql, Integer.class, fromUserId, toUserId, transferAmount, "Approved");
